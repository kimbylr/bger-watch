// config
const themen  = [ 'bliga' ]; // können substrings sein, case-insensitive
const separat = [ '5A_43/2018' ]; // separat auszuweisende urteile      *** 13.2. ***
const emailAn = 'kim@bylr.ch'; // auch mehrere möglich: 'test@qq.com, test@sohu.com, test@163.com'
        ...
        .then( (datum) => {
          ...
          request( {url: tagesliste[durchgang].url, encoding: null}, (error, response, body) => {
            if ( error === null ) {
              ...
              const emailBody = composeEmailBody( themen, entscheide_separat, entscheide_interessant, entscheide_restliche);
